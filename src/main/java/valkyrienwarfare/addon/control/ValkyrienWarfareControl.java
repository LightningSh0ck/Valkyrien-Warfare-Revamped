...
public class ValkyrienWarfareControl extends Module<ValkyrienWarfareControl> {
	...
	protected void registerItems() {
		...
		// TODO Remove me
//		Item testItem = new TestItem().setUnlocalizedName("datestitem").setRegistryName(getModID(), "datestitem").setCreativeTab(ValkyrienWarfareMod.vwTab).setMaxStackSize(1);
